...
var fightOrSkip = function () {
    ...
    if (promptFight === "skip") {
        ...
        if (confirmSkip) {
            ...
            // subtract money from player for skipping, but don't let them go into the negative
...
var endGame = function () {
    ...
    if (playerInfo.health > 0) {
        ...
        window.alert("You've lost your robot in battle. May " + playerInfo.name + " rest in peace.");
    }
...
var shop = function () {
    var shopOptionPrompt = window.prompt(
        "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter one: 'REFILL', 'UPGRADE', 'LEAVE'."
    );
